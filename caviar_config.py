...
airsim_host = "auto"
airsim_port = 41451
airsim_connection_timeout_s = 20
...
# Coordinates offset used to convert AirSim position to Sionna coordinates.
sionna_origin_offset = {"x": 23.34, "y": -3.42, "z": 137.23}

# Some maps may not include the pedestrian objects listed above.
# Disable to skip object placement/destroy logic when using custom maps.
